...
import { Scissors, Calendar, PlusCircle, LayoutDashboard, History, Settings, LogOut } from 'lucide-react'
...
function AdminLayout({ pendientes, setPendientes }) {
    ...
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth:'1200px', margin:'0 auto', padding:'0 1rem',
          ...
          {/* Nav escritorio + botón cerrar sesión */}
          <div style={{ display:'flex', alignItems:'center', gap:'8px' }}>
            ...
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.color='#fb7185'; e.currentTarget.style.borderColor='rgba(232,25,44,0.4)' }}
      ...
      {/* ── CONTENIDO ── */}
      <main style={{ flex:1, maxWidth:'1200px', margin:'0 auto', width:'100%', paddingTop:'1.5rem', paddingLeft:'1rem', paddingRight:'1rem', paddingBottom:'5rem' }}>
        <Routes>
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Rutas protegidas del panel del barbero */}
        <Route path="/*" element={
          <PrivateRoute>
            <AdminLayout pendientes={pendientes} setPendientes={setPendientes} />
          </PrivateRoute>
        } />
      </Routes>
    </BrowserRouter>
